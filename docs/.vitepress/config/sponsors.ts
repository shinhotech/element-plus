export const platinumSponsors = [
  {
    ...
    className: 'jnpf',
    banner_img: '/sh-element-plus/images/jnpfsoft.jpg',
  },
  {
    name: 'VForm',
    ...
    banner_img: '/sh-element-plus/images/vform-banner.jpg',
  },
  {
    name: 'JSDesign',
    name_cn: '即时设计',
    ...
    banner_img: '/sh-element-plus/images/js-design-banner.jpg',
  },
]
...
export const goldSponsors = [
  {
    name: 'bit',
    img: '/sh-element-plus/images/bit.svg',
  ...
  },
  {
    name: 'renren.io',
    name_cn: '人人开源',
    img: '/sh-element-plus/images/renren.png',
  ...
  },
  {
    name: 'FormMaking',
    name_cn: 'FormMaking',
    img: '/sh-element-plus/images/formmaking.png',
